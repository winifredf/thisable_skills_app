6.times do
    ...
    Skill.create(title: "Repetion", body: "Once I learn the proper process of doing something, I am really great at repeating things verbally as well as physically.", user_id:2)
